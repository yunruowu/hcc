...
TEST_F(PhyTopoConnInterfaceTest, Ut_PhyTopoConnInterface_When_ValidParameter_Expect_ConstructSuccess)
{
    std::set<std::string> ports = {"0/1", "0/2"};
...
TEST_F(PhyTopoConnInterfaceTest, Ut_PhyTopoConnInterfaceOperatorEqual_When_PortsDisorder_Expect_ReturnTrue)
{
...
TEST_F(PhyTopoConnInterfaceTest, Ut_PhyTopoConnInterfaceOperatorNotEqual_When_ParametersNotSame_Expect_ReturnTrue)
{
    std::set<std::string> ports1 = {"0/1", "0/2"};
...
TEST_F(PhyTopoNodeTest, Ut_PhyTopoNode_When_ValidParameter_Expect_ReturnIsNodeType)
{
...
TEST_F(PhyTopoPeerTest, Ut_PhyTopoNode_When_ValidParameter_Expect_ReturnIsPeer)
{
    LocalId localId = 0;
...
TEST_F(PhyTopoPeerTest, Ut_PhyTopoNode_When_ValidParameter_Expect_ReturnIsLocalId)
{
    LocalId localId = 0;
    PhyTopo::Peer peer(localId);
    EXPECT_EQ(peer.GetLocalId(), localId);
...
TEST_F(PhyTopoPeerTest, Ut_PhyTopoNode_When_ValidParameter_Expect_ReturnIsInputLocalId)
{
    LocalId localId = 0;
    NodeId nodeId = 0;
...
TEST_F(PhyTopoFabricTest, Ut_PhyTopoNode_When_ValidParameter_Expect_ReturnIsNodeType)
{
    PhyTopo::Fabric fabric;
    EXPECT_EQ(fabric.GetType(), PhyTopo::Node::NodeType::FABRIC);
}

TEST_F(PhyTopoFabricTest, Ut_PhyTopoNode_When_ValidParameter_Expect_ReturnIsNodeId)
{
    NodeId nodeId = 0;
    nodeId |= (1ULL << 32);
...
TEST_F(PhyTopoLinkTest, Ut_PhyTopoLink_When_ValidParameter_Expect_ConstructSuccess)
{
...
TEST_F(PhyTopoLinkTest, Ut_PhyTopoLink_When_ValidInterface_Expect_ReturnIsSourceIface)
{
    std::shared_ptr<PhyTopo::Node> sourceNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    std::shared_ptr<PhyTopo::Node> targetNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    PhyTopo::LinkAttributes linkAttrs;
...
TEST_F(PhyTopoLinkTest, Ut_PhyTopoLink_When_ValidInterface_Expect_ReturnIsTargetIface)
{
    std::shared_ptr<PhyTopo::Node> sourceNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    std::shared_ptr<PhyTopo::Node> targetNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    PhyTopo::LinkAttributes linkAttrs;
...
TEST_F(PhyTopoLinkTest, Ut_PhyTopoLink_When_LinkDirectionSet_Expect_ReturnIsBOTH)
{
    std::shared_ptr<PhyTopo::Node> sourceNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    std::shared_ptr<PhyTopo::Node> targetNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    PhyTopo::LinkAttributes linkAttrs;
...
TEST_F(PhyTopoLinkTest, Ut_PhyTopoLink_When_HopSet_Expect_ReturnIs1)
{
    std::shared_ptr<PhyTopo::Node> sourceNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    std::shared_ptr<PhyTopo::Node> targetNode = std::make_shared<PhyTopo::Node>(PhyTopo::Node::NodeType::PEER);
    PhyTopo::LinkAttributes linkAttrs;
...
TEST_F(PhyTopoTest, Ut_AddTopoGraph_When_TopoNotNullAndNetLayerNotExist_Expect_ReturnTopo)
{
