...
TEST_F(InsToSqeRuleV82Test, Interpret_LocalReduce)
{
    std::cout << "InsToSqeRuleV82Test 111" << std::endl;
...
TEST_F(InsToSqeRuleV82Test, Interpret_write_reduce_err)
{
    ...
    StubResMgrFetcher mockResMgrFetcher;
    insWriteReduce.localSlice_.size = 0;
    EXPECT_THROW(Interpret(insWriteReduce, stream, &mockResMgrFetcher), InvalidParamsException);
}
