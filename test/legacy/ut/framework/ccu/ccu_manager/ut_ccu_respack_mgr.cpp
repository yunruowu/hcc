...
TEST_F(CcuResPackMgrTest, should_return_success_when_calling_preparealloc)
{
    // check
...
TEST_F(CcuResPackMgrTest, should_return_success_when_calling_getrespack)
{
    // check
    CcuResPackMgr ccuResPackMgr;
    u32 expectSize = 3;
...
TEST_F(CcuResPackMgrTest, should_return_success_when_calling_firm)
{
    // check
    CcuResPackMgr ccuResPackMgr;
    u32 expectSize = 3;
...
TEST_F(CcuResPackMgrTest, should_return_success_when_calling_fallback)
{
    // check
    CcuResPackMgr ccuResPackMgr;
    u32 expectSize = 3;
