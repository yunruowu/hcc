...
TEST_F(HcomTest, HcomGetWorkspaceMemSizeV2_func_datatype_err)
{
    HcclGroupParamsV2 hcclGroupParamsV2;
    Hccl::CommParams commParams;
    std::shared_ptr<Hccl::HcclCommunicator> hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
...
TEST_F(HcomTest, Ut_HcomAlltoAllVCV2_When_Normal_Input_Expect_Success)
{
...
TEST_F(HcomTest, ut_HcomGetAlltoAllStagedWorkSpaceMemSizeV2)
{
    ...
    MOCKER_CPP(&HcclCommunicator::CalcCollOffloadOpRes).stubs().with(any()).will(returnValue(HCCL_SUCCESS));
...
TEST_F(HcomTest, ut_Hcom_GetLocalRankSizeV2)
{
...
TEST_F(HcomTest, ut_HcomCalcTaskNumV2_OpType_Not_Find_When_Abnormal_Expect_ReturnlsHCCL_E_PARA)
{
    HcclGroupParamsV2 hcclGroupParamsV2;
    Hccl::CommParams commParams;
    std::shared_ptr<Hccl::HcclCommunicator> hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
...
TEST_F(HcomTest, ut_hcomGraphAllGatherV2_When_Expect_ReturnlsHCCL_SUCCESS)
{
...
TEST_F(HcomTest, ut_hcom_graph_allreduce_v2_When_Noraml_Expect_ReturnlsHCCL_SUCCESS)
{
    TaskAbortHandler::GetInstance().commVector.clear();
    SetupAndRunCollectiveOperation(
         "testallreduce",
...
TEST_F(HcomTest, ut_hcom_graph_HcomReduceV2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupAndRunCollectiveOperation(
        "testReduce",
        [](const char* name, s8* sendbuf, s8* recvbuf, s32 count, HcclDataType type, s64 comm, rtStream_t stream) {
...
TEST_F(HcomTest, ut_hcom_HcomGraphReduceScatterV2_When_Noraml_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupAndRunCollectiveOperation(
        "testReducescatter",
        [](const char* name, s8* sendbuf, s8* recvbuf, s32 count, HcclDataType type, s64 comm, rtStream_t stream) {
...
TEST_F(HcomTest, ut_hcom_HcomGraphSendV2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    HcclGroupParamsV2 hcclGroupParamsV2;
    Hccl::CommParams commParams;
    Hccl::HcclCommunicator* hcclComm = new Hccl::HcclCommunicator(commParams);
...
TEST_F(HcomTest, ut_hcom_HcomGraphReceiveV2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    HcclGroupParamsV2 hcclGroupParamsV2;
    Hccl::CommParams commParams;
    Hccl::HcclCommunicator* hcclComm = new Hccl::HcclCommunicator(commParams);
...
TEST_F(HcomTest, ut_hcom_HcomGraphBroadcastV2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupAndRunCollectiveOperation(
        "testBroadCast",
        [](const char* name, s8* sendbuf, s8* recvbuf, s32 count, HcclDataType type, s64 comm, rtStream_t stream) {
...
TEST_F(HcomTest, ut_hcom_create_comm_buffer_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    HcclGroupParamsV2 hcclGroupParamsV2;
    Hccl::CommParams commParams;
    std::shared_ptr<Hccl::HcclCommunicator> hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
...
TEST_F(HcomTest, ut_hcom_graph_get_rank_id_and_size_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    HcclGroupParamsV2 hcclGroupParamsV2;
    Hccl::CommParams commParams;
    Hccl::HcclCommunicator* hcclComm = new Hccl::HcclCommunicator(commParams);
...
TEST_F(HcomTest, ut_hcom_get_comm_handle_by_group_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_get_topo_desc_v2_toposize_not_enough_When_Abnormal_Expect_ReturnlsHCCL_E_PARA)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_get_topo_desc_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_get_dev_type_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_set_global_work_space_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_check_comm_validity_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_support_deteministic_optim_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_set_aiv_core_limit_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_set_qo_cfg_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_hcom_unload_task_v2_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
    Hccl::CommParams commParams;
    auto hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
    HcclGroupParamsV2 hcclGroupParamsV2;
...
TEST_F(HcomTest, Ut_HcomAllGatherVV2_When_Normal_Expect_Success)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
...
TEST_F(HcomTest, Ut_HcomAllGatherVV2_When_DipHas0_Expect_Success)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomAllGatherVV2_When_OutputEq0_Expect_Success)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomAllGatherVV2_When_CountNotFixCounts_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomAllGatherVV2_When_CountTooLarge_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomAllGatherVV2_When_DatatypeNotSurport_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomReduceScatterVV2_When_DipHas0_Expect_Success)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomReduceScatterVV2_When_InuputCountEq0_Expect_Success)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomReduceScatterVV2_When_CountNotFixCounts_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomReduceScatterVV2_When_CountTooLarge_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomReduceScatterVV2_When_DatatypeNotSurport_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomReduceScatterVV2_When_ReduceOpNotSurport_Expect_Error)
{
    char tag[] = "tag";
    char group[256] = "hccl_world_group";
    constexpr u64 FAKE_RANK_SIZE = 2;
...
TEST_F(HcomTest, Ut_HcomAllReduceV2_When_HcomCheckReductionOpV2_fail_Expect_HCCL_E_NOT_SUPPORT)
{
    ...
    // 执行条件
    auto res = HcomAllReduceV2("testallreduce", sendbuf, recvbuf, count, HCCL_DATA_TYPE_INT8, HCCL_REDUCE_RESERVED, NULL, stream);
...
TEST_F(HcomTest, ut_HcomSetAivClearEnableV2_When_Normal_Expect_ReturnHCCL_SUCCESS)
{
    SetupCommonCommInfo();
    char group[256] = "hccl_world_group";
...
TEST_F(HcomTest,Ut_HcomGetAlltoAllvcStagedWorkSpaceMemSizeV2_Expect_Success)
{
...
TEST_F(HcomTest, Ut_HcomGetCommCCLBufferSizeV2_When_Call_Expect_Success)
{
...
TEST_F(HcomTest, ut_HcclGetAlgExecParamV2_When_Normal_Expect_ReturnHCCL_SUCCESS)
{
    SetupCommonCommInfo();
...
TEST_F(HcomTest, ut_HcomGetDevIdV2_expect_ReturnHCCL_SUCCESS)
{
    SetupCommonCommInfo();
