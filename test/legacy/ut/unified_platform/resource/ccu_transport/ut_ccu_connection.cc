...
TEST_F(CcuConnectionTest, Ut_GetStatus_When_InterfaceOk_Expect_Return_Ok)
{
...
TEST_F(CcuConnectionTest, Ut_GetStatus_When_TpInterfaceOk_Expect_Return_Ok)
{
...
TEST_F(CcuConnectionTest, Ut_GetStatus_When_TpInfoAlreadyHaveAndInterfaceOk_Expect_Return_Ok)
{
...
TEST_F(CcuConnectionTest, Ut_CallInterface_When_StatusUnexpected_Expect_Error)
{
    auto resPair = MockMakeCcuConnection(TpProtocol::CTP);
    auto connection = resPair.first.get();
...
TEST_F(CcuConnectionTest, Ut_GetStatus_When_CreateJettyFailed_Expect_Return_StatusInvalid)
{
    // 打桩放在其他mock之前防止被覆盖
...
TEST_F(CcuConnectionTest, Ut_GetStatus_When_ImportJettyFailed_Expect_Return_StatusInvalid)
{
...
TEST_F(CcuConnectionTest, Ut_GetStatus_When_ConfigChannelFailed_Expect_Return_StatusInvalid)
{
...
TEST_F(CcuConnectionTest, Ut_ReleaseConnRes_When_InterfaceOk_Expect_Return_Ok)
{
    auto resPair = MockMakeCcuConnection(TpProtocol::CTP);
    auto connection = resPair.first.get();
