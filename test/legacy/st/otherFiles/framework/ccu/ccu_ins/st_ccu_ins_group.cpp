...
TEST(CcuInsGroupTest, should_return_success_when_calling_setexecId)
{
    // check
...
TEST(CcuInsGroupTest, should_return_success_when_calling_append)
{
    // check
    CcuInsGroup insGroup;
    std::unique_ptr<CcuInstruction> ins = std::make_unique<CcuInstructionAllGatherMesh1D>();
...
TEST(CcuInsGroupTest, should_return_success_when_calling_getCtxSignature)
{
    // when
...
TEST(CcuInsGroupTest, should_return_success_when_calling_other)
{
    // check
    CcuInsGroup insGroup;
