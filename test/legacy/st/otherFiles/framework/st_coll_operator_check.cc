...
TEST_F(CollOperatorCheckTest, St_CheckCollOperator_When_OpType_Is_ALLTOALLVC_Expect_Success)
{
    CollOperator localOpData;
    CollOperator remoteOpData;
...
TEST_F(CollOperatorCheckTest, St_CheckCollOperator_When_ALLTOALLVC_Loacl_Sendtype_Rmt_Recvtype_Not_Equal_Expect_Fail)
{
    CollOperator localOpData;
    CollOperator remoteOpData;
    All2AllVCSetSendTypeAndRecvType(localOpData, DataType::INT8, DataType::INT8);
...
TEST_F(CollOperatorCheckTest, St_CheckCollOperator_When_ALLTOALLVC_Loacl_Recvtype_Rmt_Sendtype_Not_Equal_Expect_Fail)
{
    CollOperator localOpData;
    CollOperator remoteOpData;
