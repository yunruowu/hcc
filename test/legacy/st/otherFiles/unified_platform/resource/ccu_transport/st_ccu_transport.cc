...
TEST_F(CcuTransportTest, St_InitFailed_When_InterfaceError_Expect_Return_Error)
{
...
TEST_F(CcuTransportTest, St_GetStatusFailed_When_ConnectionError_Expect_Return_Error)
{
...
TEST_F(CcuTransportTest, St_GetStatusFailed_When_SocketError_Expect_Return_Error)
{
...
TEST_F(CcuTransportTest, St_GetStatusTimeOut_When_SocketTimeOut_Expect_Return_TimeOut)
{
...
TEST_F(CcuTransportTest, St_GetStatusError_When_SocketSendError_Expect_Return_Error)
{
...
TEST_F(CcuTransportTest, St_GetStatusError_When_HandshakeMsgInvalid_Expect_Return_Error)
{
    auto transportRes = MockMakeCcuTransport(true, true);
    auto transport = get<0>(transportRes).get();
    EXPECT_EQ(transport->Init(), HcclResult::HCCL_SUCCESS);
