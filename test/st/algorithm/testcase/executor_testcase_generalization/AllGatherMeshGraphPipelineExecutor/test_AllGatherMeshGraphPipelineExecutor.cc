...
class Test_AllGather_Mesh_Graph_Pipeline : public::testing::TestWithParam
    <std::tuple<int, CheckerDataType, vector<int>, CheckerOpMode>>
{
public:
    static void SetUpTestCase()
    {
        std::cout << "Test_AllGather_Mesh_Graph_Pipeline set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "Test_AllGather_Mesh_Graph_Pipeline tear down." << std::endl;
    }
...
TEST_P(Test_AllGather_Mesh_Graph_Pipeline, AllGather_Test)
{
    ...
    checkerOpParam.algName = "AllGatherMeshGraphPipelineExecutor";
...
std::vector<std::vector<int>> TopoList_ = {{1, 2, 7}, {1, 2, 8}, {1, 4, 16}};
INSTANTIATE_TEST_SUITE_P(TestSanity, Test_AllGather_Mesh_Graph_Pipeline,
    testing::Combine(
        ...
        testing::ValuesIn(TopoList_.begin(),TopoList_.end()),
        testing::Values(CheckerOpMode::OFFLOAD)
    )
);
