...
class RunBroadCastMeshExecutorA2Test : public::testing::TestWithParam<
    std::tuple<uint64_t, CheckerDataType, vector<int>,  CheckerOpMode, CheckerDevType, std::string, int>>
{
public:
    static void SetUpTestCase()
    {
        std::cout << "RunBroadCastMeshExecutorA2Test set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "RunBroadCastMeshExecutorA2Test tear down." << std::endl;
    }
...
TEST_P(RunBroadCastMeshExecutorA2Test, Test_BroadCastMesh_A2)
{
...
INSTANTIATE_TEST_SUITE_P(BroadCastMeshExecutor_A2, RunBroadCastMeshExecutorA2Test,
    testing::Combine(
...
class RunBroadCastMeshExecutorAlgoTest : public::testing::TestWithParam<
    std::tuple<uint64_t, CheckerDataType, vector<int>,  CheckerOpMode, CheckerDevType, std::string, bool>>
{
public:
    static void SetUpTestCase()
    {
        std::cout << "RunBroadCastMeshExecutorAlgoTest set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "RunBroadCastMeshExecutorAlgoTest tear down." << std::endl;
    }
...
TEST_P(RunBroadCastMeshExecutorAlgoTest, Test_BroadCastMesh_Algo_A2)
{
    const auto& settingTuple = GetParam();
    uint64_t dataSize =            std::get<0>(settingTuple);
    CheckerDataType dataType =        std::get<1>(settingTuple);
...
INSTANTIATE_TEST_SUITE_P(BroadCastMeshExecutor_Algo_A2, RunBroadCastMeshExecutorAlgoTest,
    testing::Combine(
        ...
        testing::Values(CheckerDevType::DEV_TYPE_910B),
        testing::Values("NHR", "H-D_R", "NHR_V1"), // Broadcast 仅支持 HD NHR NB NHRV1
        testing::Values(true)
    )
);