...
class RunAllGatherMeshExecutorA2Test : public::testing::TestWithParam<
    std::tuple<uint64_t, CheckerDataType, vector<int>,  CheckerOpMode, CheckerDevType, std::string>>
{
public:
    static void SetUpTestCase()
    {
        std::cout << "RunAllGatherMeshExecutorTest set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "RunAllGatherMeshExecutorTest tear down." << std::endl;
    }
...
TEST_P(RunAllGatherMeshExecutorA2Test, Test_AllGatherMesh_A2)
{
    ...
    std::cout <<  "--- dataSize=" << dataSize << ", dataType=" << dataType <<
                ", --- opMode=" << opMode <<
...
INSTANTIATE_TEST_SUITE_P(AllGatherMeshExecutor_A2, RunAllGatherMeshExecutorA2Test,
    testing::Combine(
...
class RunAllGatherMeshExecutorAlgoA2Test : public::testing::TestWithParam<
    std::tuple<uint64_t, CheckerDataType, vector<int>,  CheckerOpMode, CheckerDevType, std::string, bool>>
{
public:
    static void SetUpTestCase()
    {
        std::cout << "RunAllGatherMeshExecutorAlgoTest set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "RunAllGatherMeshExecutorAlgoTest tear down." << std::endl;
    }
...
TEST_P(RunAllGatherMeshExecutorAlgoA2Test, Test_AllGatherMesh_Algo_A2)
{
    const auto& settingTuple = GetParam();
    uint64_t dataSize =            std::get<0>(settingTuple);
    CheckerDataType dataType =        std::get<1>(settingTuple);
...
INSTANTIATE_TEST_SUITE_P(AllGatherMeshExecutor_Algo_A2, RunAllGatherMeshExecutorAlgoA2Test,
    testing::Combine(
        ...
        testing::Values(CheckerOpMode::OPBASE, CheckerOpMode::OFFLOAD),
        testing::Values(CheckerDevType::DEV_TYPE_910B),
        testing::Values("ring", "NHR", "H-D_R", "NHR_V1"),
        testing::Values(true)
    )
);