...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_SendBufIsNull_Expect_ReturnIsHCCL_E_PTR)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_RecvBufIsNull_Expect_ReturnIsHCCL_E_PTR)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_CountIsZero_Expect_ReturnIsHCCL_SUCCESS)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_CountIsTooLarge_Expect_ReturnIsHCCL_E_PARA)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_CommIsNull_Expect_ReturnIsHCCL_E_PTR)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_DeviceNotSupport_Expect_ReturnIsHCCL_E_NOT_SUPPORT)
{
    UT_SET_SENDBUF_RECVBUF_COUNT(HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_DataSize300MB_Expect_ReturnIsHCCL_SUCCESS)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_Exec20times_Expect_ReturnIsHCCL_SUCCESS)
{
...
TEST_F(HcclAllReduceTest, Ut_HcclAllReduce_When_2Server4Rank_Expect_ReturnIsHCCL_SUCCESS)
{
    UT_SET_SENDBUF_RECVBUF_COUNT(HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
