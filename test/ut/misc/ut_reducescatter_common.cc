...
void* impl_common_reduce_scatter_task_ffts(void* parg)
{
    HcclResult ret = HCCL_SUCCESS;
    para_t* para_info = (para_t*)parg;
    s32 rank_num_tmp;
    ...
    if (stream_list_size > 0) {
        ...
        ret = hcom_info.pComm->GetWorkspaceMemSize("HcomReduceScatter_ffts", para_info->count, para_info->datatype, rankSize, memSize);
        EXPECT_EQ(ret, HCCL_SUCCESS);
        
        ret = hrtMalloc(&memptr, memSize);
        EXPECT_EQ(ret, HCCL_SUCCESS);

        ret = hcom_info.pComm->SetWorkspaceResource("tag_impl_common_reduce_scatter_task_ffts", memptr, memSize, streamList);
        EXPECT_EQ(ret, HCCL_SUCCESS);
    }
    //-----------------Get Workspace Resource End------------------//
    rank_num_tmp = *(para_info->sync_addr) - 1;
    ...
    ret =  hcom_info.pComm->ReduceScatterOutPlace("tag_impl_common_reduce_scatter_task_ffts",
                               para_info->sendbuff,
                               para_info->recvbuff,
                               para_info->count,
                               para_info->datatype,
...
class ReduceScatterCommonTest : public testing::TestWithParam<bool>
{
protected:
...
#if 1
TEST_P(ReduceScatterCommonTest, ut_hccl_impl_610_8rank_1server_reduce_scatter_char)
{
    char file_name_t[] = "./st_hccl_impl_610_8rank_1server_reduce_scatter_char.json";
...
{
    char file_name_t[] = "./st_hccl_impl_610_8rank_1server_reduce_scatter_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./st_hccl_impl_610_5rank_1server_reduce_scatter_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./st_hccl_impl_610_4rank_1server_reduce_scatter_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./st_hccl_impl_610_2rank_1server_reduce_scatter_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./st_hccl_impl_610_3rank_1server_reduce_scatter_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./st_hccl_impl_610_2rank_1server_reduce_scatter_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./st_hccl_impl_610_8rank_1server_reduce_scatter_memsampler_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
