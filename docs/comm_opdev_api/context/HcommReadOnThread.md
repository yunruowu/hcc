# HcommReadOnThread<a name="ZH-CN_TOPIC_0000002507941302"></a>
...
<tbody><tr id="row17472816"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.4.1.1 "><p id="p32201453361"><a name="p32201453361"></a><a name="p32201453361"></a>thread</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.4.1.2 "><p id="p121864106362"><a name="p121864106362"></a><a name="p121864106362"></a>输入</p>
</td>
...
<p id="p1480073954913"><a name="p1480073954913"></a><a name="p1480073954913"></a>ThreadHandle类型的定义可参见<a href="ThreadHandle.md">ThreadHandle</a>。</p>
</td>
</tr>
<tr id="row63522246"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.4.1.1 "><p id="p11220558361"><a name="p11220558361"></a><a name="p11220558361"></a>channel</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.4.1.2 "><p id="p318631018365"><a name="p318631018365"></a><a name="p318631018365"></a>输入</p>
</td>
...
<tr id="row20735233"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.4.1.1 "><p id="p132201513363"><a name="p132201513363"></a><a name="p132201513363"></a>dst</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.4.1.2 "><p id="p918661016368"><a name="p918661016368"></a><a name="p918661016368"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.1.4.1.3 "><p id="p143551914203620"><a name="p143551914203620"></a><a name="p143551914203620"></a>目标内存地址。</p>
</td>
</tr>
<tr id="row1755105918352"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.4.1.1 "><p id="p922075193612"><a name="p922075193612"></a><a name="p922075193612"></a>src</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.4.1.2 "><p id="p17186121016364"><a name="p17186121016364"></a><a name="p17186121016364"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.1.4.1.3 "><p id="p535510144364"><a name="p535510144364"></a><a name="p535510144364"></a>源内存地址。</p>
</td>
</tr>
<tr id="row1975545914352"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.4.1.1 "><p id="p102201358365"><a name="p102201358365"></a><a name="p102201358365"></a>len</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.4.1.2 "><p id="p1218681014366"><a name="p1218681014366"></a><a name="p1218681014366"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.1.4.1.3 "><p id="p15355151453620"><a name="p15355151453620"></a><a name="p15355151453620"></a>数据长度（字节）。</p>
</td>
</tr>
</tbody>
</table>
...
void Sample(HcclComm comm, ChannelHandle channel, HcclThread threadHandle, uint32_t rank)
{
    if (rank == 0) {
        ...
        // 将对端内存的内容读到本端内存上
        HcommReadOnThread(threadHandle, channel, localBuf.addr, remoteBuf.addr, len);
