# get\_local\_rank\_size<a name="ZH-CN_TOPIC_0000001312713849"></a>
...
<td class="cellrowborder" valign="top" width="62.12%" headers="mcps1.1.4.1.3 "><p id="p4661258122713"><a name="p4661258122713"></a><a name="p4661258122713"></a>String类型，最大长度为128字节，含结束符。</p>
<p id="p143461255123316"><a name="p143461255123316"></a><a name="p143461255123316"></a>group名称，如果用户不配置此参数，默认为“hccl_world_group”。</p>
</td>
</tr>
</tbody>
</table>
...
-   [create\_group](create_group.md)完成之后，调用此API获取本group的local rank数量。
-   如果传入"hccl\_world\_group"，返回world\_group的local rank数量。
