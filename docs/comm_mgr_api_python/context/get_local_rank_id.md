# get\_local\_rank\_id<a name="ZH-CN_TOPIC_0000001312473765"></a>
...
<table><thead align="left"><tr id="zh-cn_topic_0146324969_row8953505"><th class="cellrowborder" valign="top" width="15.89%" id="mcps1.1.4.1.1"><p id="zh-cn_topic_0146324969_p54145286"><a name="zh-cn_topic_0146324969_p54145286"></a><a name="zh-cn_topic_0146324969_p54145286"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="15.229999999999999%" id="mcps1.1.4.1.2"><p id="zh-cn_topic_0146324969_p23692060"><a name="zh-cn_topic_0146324969_p23692060"></a><a name="zh-cn_topic_0146324969_p23692060"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="68.88%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0146324969_p19480441"><a name="zh-cn_topic_0146324969_p19480441"></a><a name="zh-cn_topic_0146324969_p19480441"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0146324969_row41106249"><td class="cellrowborder" valign="top" width="15.89%" headers="mcps1.1.4.1.1 "><p id="p1010834583413"><a name="p1010834583413"></a><a name="p1010834583413"></a>group</p>
</td>
<td class="cellrowborder" valign="top" width="15.229999999999999%" headers="mcps1.1.4.1.2 "><p id="p11066451345"><a name="p11066451345"></a><a name="p11066451345"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="68.88%" headers="mcps1.1.4.1.3 "><p id="p8793327123212"><a name="p8793327123212"></a><a name="p8793327123212"></a>String类型，最大长度为128字节，含结束符。</p>
<p id="p105483143347"><a name="p105483143347"></a><a name="p105483143347"></a>group名称，如果用户不配置此参数，默认为“hccl_world_group”。</p>
</td>
</tr>
</tbody>
</table>
...
-   [create\_group](create_group.md)完成之后，调用此API获取进程在group中的local rank id。
-   如果传入"hccl\_world\_group"，返回进程在world\_group的local rank id。
