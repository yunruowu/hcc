# get\_rank\_size<a name="ZH-CN_TOPIC_0000001312633761"></a>
...
<th class="cellrowborder" valign="top" width="16.669999999999998%" id="mcps1.1.4.1.2"><p id="zh-cn_topic_0146324969_p23692060"><a name="zh-cn_topic_0146324969_p23692060"></a><a name="zh-cn_topic_0146324969_p23692060"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="62.629999999999995%" id="mcps1.1.4.1.3"><p id="zh-cn_topic_0146324969_p19480441"><a name="zh-cn_topic_0146324969_p19480441"></a><a name="zh-cn_topic_0146324969_p19480441"></a>描述</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="16.669999999999998%" headers="mcps1.1.4.1.2 "><p id="p11066451345"><a name="p11066451345"></a><a name="p11066451345"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="62.629999999999995%" headers="mcps1.1.4.1.3 "><p id="p186634402714"><a name="p186634402714"></a><a name="p186634402714"></a>String类型，最大长度为128字节，含结束符。</p>
<p id="p9885346175213"><a name="p9885346175213"></a><a name="p9885346175213"></a>group名称，如果用户不配置此参数，默认为“hccl_world_group”。</p>
</td>
</tr>
</tbody>
</table>
...
-   [create\_group](create_group.md)完成之后，调用此API获取本group的rank数量；
-   如果传入"hccl\_world\_group"，返回hccl world group的rank数量。
