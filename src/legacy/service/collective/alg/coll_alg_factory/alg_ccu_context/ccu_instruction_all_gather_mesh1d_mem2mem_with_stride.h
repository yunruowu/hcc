...
#ifndef HCCLV2_CCU_INSTRUCTION_ALL_GATHER_MESH_1D_MEM2MEM_WITH_STRIDE_H_
#define HCCLV2_CCU_INSTRUCTION_ALL_GATHER_MESH_1D_MEM2MEM_WITH_STRIDE_H_
...
public:
    ...
    {
        return std::make_unique<CcuTaskArgAllGatherMesh1DMem2MemWithStride>(
...
#endif // HCCLV2_CCU_INSTRUCTION_ALL_GATHER_MESH_1D_MEM2MEM_WITH_STRIDE_H_
