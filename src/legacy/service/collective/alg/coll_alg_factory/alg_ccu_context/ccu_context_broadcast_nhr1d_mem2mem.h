...
#ifndef CUPT_KERNEL_CCU_CONTEXT_BROADCAST_NHR_1D_H_
#define CUPT_KERNEL_CCU_CONTEXT_BROADCAST_NHR_1D_H_
#include <vector>
...
#include "ccu_instruction_broadcast_nhr1d_mem2mem.h"

namespace Hccl {

class CcuContextBroadcastNHRMem2Mem1D : public CcuContext {
public:
    CcuContextBroadcastNHRMem2Mem1D(const CcuCtxArg &arg, const std::vector<CcuTransport*> &transports,
                                                   const CcuTransportGroup &group);
    ~CcuContextBroadcastNHRMem2Mem1D() override {}
...
#endif // HCCLV2_CCU_CONTEXT_BROADCAST_NHR_1D_H_
