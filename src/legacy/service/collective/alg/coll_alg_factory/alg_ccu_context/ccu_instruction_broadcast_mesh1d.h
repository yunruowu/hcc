...
#ifndef HCCLV2_CCU_INSTRUCTION_BROADCAST_MESH_1D_H_
#define HCCLV2_CCU_INSTRUCTION_BROADCAST_MESH_1D_H_
...
public:
    ...
    CcuCtxSignature GetCtxSignature() const override
    {
        ...
        GenerateCcuCtxSignature(signature, ccuInsType_, op_, tempVTopo_);
        return signature;
    }
...
private:
    CcuInstType instType_ = CcuInstType::CCU_BROADCAST_MESH_1D_DIRECT;
    std::vector<uint64_t> dimSize_;
    uint32_t missionId_{0};
    uint32_t rankId_{0};
    uint32_t rootId_{0}; // add
