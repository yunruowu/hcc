...
std::string ParseLoadSqeArgsToGSAInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Load SqeArg[%u] to GSA[%u]", sqeArgsId, gsaId);
}
...
static std::string ParseLoadSqeArgsToXnInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Load SqeArg[%u] to Xn[%u]", sqeArgsId, xnId);
}
...
static std::string ParseLoadImdToGSAInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Load immediate[%llu] to GSA[%u]", immediate, gsaId);
}
...
static std::string ParseLoadImdToXnInstr(const CcuInstr *instr)
{
    ...
    if (instr->v1.loadImdToXn.secFlag == CCU_LOAD_TO_XN_SEC_INFO) {
        return StringFormat("Load immediate[tokenInfo] to Xn[%u]", xnId);
    }

    return StringFormat("Load immediate[%llu] to Xn[%u]", immediate, xnId);
}
...
static std::string ParseLoadGSAXnInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Load GSA[%u] + Xn[%u] to GSA[%u]", gsAmId, xnId, gsAdId);
}
...
static std::string ParseLoadGSAGSAInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Load GSA[%u] + GSA[%u] to GSA[%u]", gsAmId, gsAnId, gsAdId);
}
...
static std::string ParseLoadXXInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Load Xn[%u] + Xn[%u] to Xn[%u]", xmId, xnId, xdId);
}
...
static std::string ParseLoopInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Loop From startInstrId[%u] to endInstrId[%u] with loopXn[%u]", startInstrId, endInstrId, xnId);
}
...
static std::string ParseLoopGroupInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("LoopGroup From startLoopInstrId[%u] with loopGroupXn[%u], offsetXn[%u] and highPerfModeEn[%u]",
...
static std::string ParseSetCKEInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Set CKE[%u:%04x], clearType[%u]", waitCKEId, waitCKEMask, setCKEId,
...
static std::string ParseJumpInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("When conditionXn[%u] not equal to expectData[%llu], Jump To InstrIdXn[%u]", conditionXnId,
...
static std::string ParseTransLocMemToLocMSInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans LocMem[%u:%u] To LocMS[%u:%u] With LengthXn[%u] Use Channel[%u], Set "
...
static std::string ParseTransRmtMemToLocMSInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans RmtMem[%u:%u] To LocMS[%u:%u] With LengthXn[%u] Use Channel[%u], Set "
                        "CKE[%u:%04x], clearType[%u], lengthEn[%u]",
...
static std::string ParseTransLocMSToLocMemInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans LocMS[%u:%u] To LocMem[%u:%u] With LengthXn[%u] Use Channel[%u], Set "
                        "CKE[%u:%04x], clearType[%u], lengthEn[%u]",
...
static std::string ParseTransLocMSToRmtMemInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans LocMS[%u:%u] To RmtMem[%u:%u] With LengthXn[%u] Use Channel[%u], Set "
                        "CKE[%u:%04x], clearType[%u], lengthEn[%u]",
...
static std::string ParseTransRmtMSToLocMemInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans RmtMS[%u:%u] To LocMem[%u:%u] With LengthXn[%u] Use Channel[%u], Set "
                        "CKE[%u:%04x], clearType[%u], lengthEn[%u]",
...
static std::string ParseTransLocMSToLocMSInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans LocMS[%u:%u] To LocMS[%u:%u] With LengthXn[%u] Use Channel[%u], "
                        "Set CKE[%u:%04x], "
...
static std::string ParseTransRmtMSToLocMSInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans RmtMS[%u:%u] To LocMS[%u:%u] With LengthXn[%u] Use Channel[%u], "
                        "Set CKE[%u:%04x], "
                        "clearType[%u], lengthEn[%u]",
...
static std::string ParseTransLocMSToRmtMSInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Trans LocMS[%u:%u] To RmtMS[%u:%u] With LengthXn[%u] Use Channel[%u], Set "
...
static std::string ParseSyncCKEInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Sync LocCKE[%u:%04x] To rmtCKE[%u:%04x] Use Channel[%u], Set "
...
static std::string ParseSyncXnInstr(const CcuInstr *instr)
{
    ...
    return StringFormat("Wait CKE[%u:%04x], Sync locXnId[%u] To rmtXnId[%u] Use Channel[%u], Set rmtCKE[%u:%04x], Set "
                        "CKE[%u:%04x], clearType[%u]",
