...
#ifndef HCCL_SRC_DLTDTFUNCTION_H
#define HCCL_SRC_DLTDTFUNCTION_H
...
#ifndef HCCD
    std::function<uint32_t(uint32_t deviceLogicId, int32_t type, uint64_t ptr)> dlTsdCapabilityGet;
#endif
