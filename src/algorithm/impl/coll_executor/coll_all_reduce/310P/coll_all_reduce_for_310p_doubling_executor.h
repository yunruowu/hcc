...
#ifndef COLL_ALLREDUCE_FOR_310P_DOUBLING_EXECUTOR_H
#define COLL_ALLREDUCE_FOR_310P_DOUBLING_EXECUTOR_H
...
public:
    ...
    ~CollAllReduceFor310PDoublingExecutor() override = default;
