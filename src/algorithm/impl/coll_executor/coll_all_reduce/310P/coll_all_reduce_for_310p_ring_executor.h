...
#ifndef COLL_ALLREDUCE_FOR_310P_RING_EXECUTOR_H
#define COLL_ALLREDUCE_FOR_310P_RING_EXECUTOR_H
#include "coll_all_reduce_executor.h"
namespace hccl {
class CollAllReduceFor310PRingExecutor : public CollAllReduceExecutor {
