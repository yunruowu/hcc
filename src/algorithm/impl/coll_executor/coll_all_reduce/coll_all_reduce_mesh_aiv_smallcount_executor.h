...
#ifndef COLL_ALLREDUCE_MESH_AIV_SMALLCOUNT_EXECUTOR_H
#define COLL_ALLREDUCE_MESH_AIV_SMALLCOUNT_EXECUTOR_H

#include "coll_all_reduce_executor.h"
#include "hccl_aiv.h"

namespace hccl {
class CollAllReduceMeshAivSmallCountExecutor : public CollAllReduceExecutor {
public:
    CollAllReduceMeshAivSmallCountExecutor(const HcclDispatcher dispatcher,
                                               std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollAllReduceMeshAivSmallCountExecutor() override = default;
