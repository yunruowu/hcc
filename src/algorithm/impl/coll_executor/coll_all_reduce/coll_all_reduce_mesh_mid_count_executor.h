...
#ifndef COLL_ALLREDUCE_MESH_MID_COUNT_LOOP_EXECUTOR_H
#define COLL_ALLREDUCE_MESH_MID_COUNT_LOOP_EXECUTOR_H
...
public:
    ...
    ~CollAllReduceMeshMidCountExecutor() override = default;
