...
#include "coll_reduce_scatter_ars_for_910_93_executor.h"
...
HcclResult CollReduceScatterARSFor91093Executor::CalcStreamNum(u32& streamNum)
{
...
HcclResult CollReduceScatterARSFor91093Executor::GetLevelCommInfo()
{
