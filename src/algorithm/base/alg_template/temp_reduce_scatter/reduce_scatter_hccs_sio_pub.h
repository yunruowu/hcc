...
#ifndef REDUCE_SCATTER_HCCS_SIO_PUB_H
#define REDUCE_SCATTER_HCCS_SIO_PUB_H
...
namespace hccl {
class ReduceScatterHccsSio : public AlgTemplateBase {
public:
    explicit ReduceScatterHccsSio(const HcclDispatcher dispatcher);
