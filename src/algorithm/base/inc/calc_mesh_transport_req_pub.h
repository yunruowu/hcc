...
#ifndef CALC_MESH_TRANSPORT_REQ_PUB_H
#define CALC_MESH_TRANSPORT_REQ_PUB_H

#include "calc_transport_req_base.h"

namespace hccl {
class CalcMeshTransportReq : public CalcTransportReqBase {
public:
...
#endif /* CALC_MESH_TRANSPORT_REQ_PUB_H */