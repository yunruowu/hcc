...
class AivAllReduceDeterMid910B : public AivCommBase {
public:
    __aicore__ inline AivAllReduceDeterMid910B() {}
...
template<typename T>
__aicore__ inline void AivAllReduceDeterMid910B::CPGM2GMAccordingFlag(__gm__ T *cclGMSelf, __gm__ T *cclGMOther,
...
__aicore__ inline int64_t AivAllReduceDeterMid910B::GetDeterministicRankOffset(int64_t x)
{
    int64_t tmp = 1;
    while(!(x & 1)) {
        x >>= 1;
...
template<typename T>
__aicore__ inline void AivAllReduceDeterMid910B::SumByPairs(__gm__ T *cclGMSelf, int64_t x, int64_t count,
...
template<typename T>
__aicore__ inline void AivAllReduceDeterMid910B::ReduceWithFlagWrap(__gm__ T *cclGMSelf, __gm__ T *cclGMOther, 
...
template<typename T>
__aicore__ inline void AivAllReduceDeterMid910B::Process(GM_ADDR input, GM_ADDR output, uint64_t len, int32_t tag, 
                                                        uint64_t bufferSize)
{
